...
class TestAgentState:
    ...
    def test_create_initial_state(self):
        """测试创建初始状态"""
        state = create_initial_state("session_123", "如何获得原石？")
...
class TestAgentNodes:
    ...
    async def test_reasoning_node(self):
        ...
        state = create_initial_state("test_001", "如何获得原石？")
        mock_llm = MagicMock()
    ...
    async def test_human_node(self):
        ...
        state = create_initial_state("test_003", "我要投诉封号")
...
class TestAgentIntegration:
    ...
    async def test_full_flow_no_interrupt(self):
        ...
        with patch("agent.graph.graph") as mock_graph:
            ...
            result = await run_agent("test_session", "如何获得原石？")
